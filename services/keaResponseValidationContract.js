...
const VIOLATION_CODE = Object.freeze({
  ...
  TREND_COVERAGE_MISMATCH: 'TREND_COVERAGE_MISMATCH',
  LOOKUP_ATTRIBUTION_MISMATCH: 'LOOKUP_ATTRIBUTION_MISMATCH',
  SNAPSHOT_NEGATIVE_MINIMUM_MISMATCH: 'SNAPSHOT_NEGATIVE_MINIMUM_MISMATCH',
  COMPARISON_METRIC_MISMATCH: 'COMPARISON_METRIC_MISMATCH',
});
