...
const suites = [
  ...
  './keaUpcomingAnalysis.test.js',
  './keaIncomeHorizon.test.js',
  './keaEvidenceLedger.test.js',
  './keaEvidencePromptView.test.js',
  './keaEvidencePromptCutover.test.js',
  './keaEvidenceTelemetry.test.js',
  ...
  './keaSnapshotEvidenceCutover.test.js',
  ...
  './keaComparisonMetricSemanticValidation.test.js',
  './keaTrendBlockedDiagnosticTelemetry.test.js',
  ...
  './keaConversationContinuation.test.js',
