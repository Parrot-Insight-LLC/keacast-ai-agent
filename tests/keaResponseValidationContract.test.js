...
async function run() {
  ...
  check('violation enum reserved', VIOLATION_CODE.UNSUPPORTED_AMOUNT === 'UNSUPPORTED_AMOUNT'
    ...
    && VIOLATION_CODE.LOOKUP_ATTRIBUTION_MISMATCH === 'LOOKUP_ATTRIBUTION_MISMATCH'
    && VIOLATION_CODE.SNAPSHOT_NEGATIVE_MINIMUM_MISMATCH === 'SNAPSHOT_NEGATIVE_MINIMUM_MISMATCH'
    && VIOLATION_CODE.COMPARISON_METRIC_MISMATCH === 'COMPARISON_METRIC_MISMATCH');
