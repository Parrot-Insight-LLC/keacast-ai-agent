...
exports.chat = async (req, res) => {
  try {
    ...
    const actualContext = `Here is my current transactions: ${contextSummary.plaidTransactions}, here is my current categories: ${contextSummary.categories}, here is my current upcoming transactions: ${contextSummary.upcomingTransactions}, here is my forecasted transactions: ${contextSummary.cfTransactions}, here is my recent transactions: ${contextSummary.recentTransactions}, here is my category spending breakdown: ${contextSummary.breakdown}`;
